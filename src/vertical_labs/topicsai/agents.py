...
from ..tools.content_tools import (ContentDiversityTool,
                                   ...
                                   WebsiteAnalyzerTool)
from ..tools.news_tools import (GoogleNewsTool, NewsScraperTool,
                                TwitterTrendsTool)
...
def create_topic_researcher(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory=(
            "As the Lead Topic Researcher, you specialize in uncovering trending topics "
...
def create_audience_analyst(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory=(
            "With a strong background in demographic analysis and user behavior interpretation, "
...
def create_content_strategist(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory=(
            "As a Content Strategy Specialist, you have a keen sense for evaluating "
...
def create_seo_specialist(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory=(
            "Your skills in keyword analysis and search intent interpretation make "
...
def create_quality_assurer(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory=(
            "With an eye for detail and a knack for quality control, you review and "
...
def create_topic_coordinator(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory=(
            "Leading the coordination of topic generation, you manage the workflow "
