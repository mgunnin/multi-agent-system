...
from ..tools.pitch_tools import PitchGeneratorTool, BrandMatchingTool, PitchOptimizationTool
...
def create_brand_analyst(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory="As a Brand Analysis Specialist, you excel at understanding brand values, "
...
def create_pitch_writer(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory="You are a master of crafting persuasive pitches that highlight the "
...
def create_media_relations_specialist(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory="With years of experience in media relations, you understand what makes "
...
def create_pitch_coordinator(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory="You manage the end-to-end pitch creation process, ensuring that all "
