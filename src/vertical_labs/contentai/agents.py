...
def create_content_researcher(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        backstory="As a Content Research Specialist, you excel at finding and validating "
...
def create_content_writer(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        goal="Create engaging, high-quality content that meets editorial standards",
        backstory="You are a skilled writer who can adapt to different styles and tones. "
...
def create_content_editor(config: Dict) -> Agent:
    ...
    return Agent(
        role="Content Editor",
        goal="Ensure content quality, accuracy, and alignment with guidelines",
        backstory="With a sharp eye for detail and strong editorial judgment, you ensure "
...
def create_content_optimizer(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        goal="Optimize content for maximum impact and engagement",
        backstory="You specialize in optimizing content for both search engines and "
...
def create_content_coordinator(config: Dict) -> Agent:
    ...
    return Agent(
        ...
        goal="Oversee content creation process and ensure timely delivery",
        backstory="You manage the end-to-end content creation process, ensuring all "
